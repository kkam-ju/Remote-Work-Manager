...
BOOL CWritePostDlg::OnInitDialog()
{
    ...
    GetDlgItem(IDC_STATIC_PTITLE)->SetFont(&m_fontLabel);
    GetDlgItem(IDC_STATIC_PCON)->SetFont(&m_fontLabel);
...
HBRUSH CWritePostDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
